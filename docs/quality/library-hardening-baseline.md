...
- package-level coverage, advisory mutation automation, benchmark evidence, and fuzz harnesses for parser-facing code
...
4. backed by benchmark or fuzz evidence where the public path is hot or wire-facing
